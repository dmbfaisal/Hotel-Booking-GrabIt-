			...
			<div id="wrapper">
				...
				<!-- Banner -->
					<section id="intro" class="main">
						...
						<h2><%=fran%></h2>
						<p>Add new Hotels and manage existing one!! 
						</p>
				...
				<!-- Items -->
					<section class="main items">
						<article class="item">
							<header>
								<a href="addHotel.jsp"><img src="welcome/images/pic01.jpg" alt="" /></a>
								<h3>Add new Hotel</h3>
							</header>
							<p>Add new Hotel to your Franchise!</p>
							<ul class="actions">
								<li><a href="servlet/AddHotel" class="button">Add new Hotel</a></li>
							</ul>
						</article>
						<!--  <article class="item">
							<header>
